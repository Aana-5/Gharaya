            ...
            <Box
                sx={{
                    ...
                    "&::before": {
                        ...
                        borderRadius: "50% 50% 0 0 / 100% 100% 0 0", // default for desktop
                        transform: "scaleX(1.5)",
                        zIndex: 0,
                    },
                    [theme.breakpoints.down("sm")]: {
                        "&::before": {
                            borderRadius: "100% 100% 0 0 / 40% 40% 0 0", // flatter curve for mobile
                ...
                <Grid container spacing={4} maxWidth="lg" margin="auto">
                    ...
                    <Grid item xs={12} sm={6} md={3}>
                        ...
                        <Box display="flex" flexDirection="column" gap={1}>
                            ...
                            <Grid item><Link href="#" underline="hover" color="#fff" sx={animatedLinkStyle}>About Us</Link></Grid>
                            <Grid item>
                                <Link
