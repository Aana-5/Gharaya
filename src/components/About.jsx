   ...
   <div className="container-fluid">
      ...
      <div className="row">
        <div className="col m-3 d-flex justify-content-center">
          <img
            src="../src/assets/images/mainwalpaper.jpg"
            alt="main wallpaper"
      ...
      <div className="row flex-column flex-md-row align-items-center my-5">
        <div className="col-md-6 text-center mb-4 mb-md-0">
          <img
            src="../src/assets/images/farmjpg2.avif"
            alt="farm"
            className="img-fluid rounded"
            style={{ maxWidth: "70%" }}
          />
      ...
      <div className="row flex-column flex-md-row align-items-center my-5">
        ...
        <div className="col-md-6 text-center order-1 order-md-2 mb-4 mb-md-0">
          <img
            src="../src/assets/images/imageproject1.jpg"
            alt="Discover"
            className="img-fluid rounded"
            style={{ maxWidth: "70%" }}
          />
      ...
      <div className="row flex-column flex-md-row align-items-center my-5">
        <div className="col-md-6 text-center mb-4 mb-md-0">
          <img
            src="../src/assets/images/premiumquality1.jpg"
            alt="Premium"
            className="img-fluid rounded"
            style={{ maxWidth: "70%" }}
          />
      ...
      <div className="row flex-column flex-md-row align-items-center my-5">
        ...
        <div className="col-md-6 text-center order-1 order-md-2 mb-4 mb-md-0">
          <img
            src="../src/assets/images/origin.jpg"
            alt="Origin"
            className="img-fluid rounded"
            style={{ maxWidth: "70%" }}
          />
      ...
      <div className="row flex-column flex-md-row align-items-center my-5">
        <div className="col-md-6 text-center mb-4 mb-md-0">
          <img
            src="../src/assets/images/lastimage.jpg"
            alt="GHARAYA"
            className="img-fluid rounded"
            style={{ maxWidth: "70%" }}
          />
