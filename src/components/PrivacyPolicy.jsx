    ...
    <div className="container-fluid px-1 px-md-1 py-1">
      ...
      <div className="row justify-content-center">
        <div className="col-12 col-md-10 text-start">
          ...
          <h4 className="mt-3">Cookies and Tracking Technologies</h4>
          <p>
          ...
          <h3 className="mt-4">How We Share Your Information</h3>
          ...
          <h3 className="mt-4">Security of Your Information</h3>
          <p>
          ...
          <h3 className="mt-4">Third-Party Websites</h3>
          <p>
          ...
          <h3 className="mt-4">Your Privacy Rights</h3>
          <p>
